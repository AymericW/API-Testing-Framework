...
node ('master'){
    ...
    nodeImage.inside('-u root') {
        ...
        stage ('Upload the Report') {
            steps.sh 'sh ./scripts/uploadscript.sh "CUSTOMERS" "Current_Release" "API" "API Testing Consent" "Full Test" "API" "QAP1" "cucumberQA.json" "http://wpdm0104.be.fortis.bank:8000/"'
        }
    }
