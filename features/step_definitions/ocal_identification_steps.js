...
// const IDENT_URL = "https://i-net1938a-test.be.fortis.bank:51088/OCAL-ap55-war/api/scan-id/identifications";
...
//     statusCode = response.statusCode
//     console.log("Get prospect id is " + getData.id)
...
//     // console.log("POST identification id is " + global.postData.id)
//     // console.log(request)
// });
...
//     // callApiGet(PROSPECT_URL + "/" + global.postData);
